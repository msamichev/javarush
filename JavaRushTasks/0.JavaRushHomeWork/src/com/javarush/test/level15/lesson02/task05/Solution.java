...
public class Solution
{
    ...
    {
        System.out.println("Yes".equalsIgnoreCase((String)new BodyPart("Рука").containsBones()));
    }
    ...
    public static class BodyPart implements Alive
    {
        ...
        {
            return "Yes".equalsIgnoreCase((String) containsBones()) ? name + " содержит кости" : name + " не содержит кости";
        }
    }
    ...
    public static class Finger extends BodyPart
    {
        ...
        public Object containsBones()
        {
            return "Yes".equalsIgnoreCase((String) super.containsBones()) && !isFoot ? "Yes" : "No";
        }
    }
}
