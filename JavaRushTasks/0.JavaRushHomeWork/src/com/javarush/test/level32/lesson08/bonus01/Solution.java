...
public class Solution
{
    ...
    {
        Class[] interfacesList = new Class[interfaces.length + 1];
        System.arraycopy(interfaces, 0, interfacesList, 0, interfaces.length);
        interfacesList[interfacesList.length - 1] = clazz;
        return (T) Proxy.newProxyInstance(clazz.getClassLoader(), interfacesList, new ItemInvocationHandler());
    }
}
