...
public class Solution
{
    ...
    public static HashMap<String, Date> createMap()
    {
        ...
        map.put("Stallone8", new Date("NOVEMBER 2 1980"));
        map.put("Stallone9", new Date("NOVEMBER 3 1980"));
    ...
    public static void removeAllSummerPeople(HashMap<String, Date> map)
    {
        ...
        {
            if(stringDateEntry.getValue().getMonth() < 8 && stringDateEntry.getValue().getMonth() > 4){
                map.remove(stringDateEntry.getKey());
            }
        }
