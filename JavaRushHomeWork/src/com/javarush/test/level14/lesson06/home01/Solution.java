...
public class Solution
{
    ...
    static class HenFactory
    {
        ...
        static Hen getHen(String country)
        {
            ...
            if (Country.UKRAINE.equalsIgnoreCase(country))
            {
                hen = new UkrainianHen();
            } else if (Country.MOLDOVA.equalsIgnoreCase(country))
            {
                hen = new MoldovanHen();

            } else if (Country.BELARUS.equalsIgnoreCase(country))
            {
                hen = new BelarusianHen();
            } else if (Country.RUSSIA.equalsIgnoreCase(country))
            {
                hen = new RussianHen();
