...
public class Solution extends SimpleFileVisitor<Path>
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Files.walkFileTree(Paths.get("c:/temp"), options, 20, solution);
    ...
    {
        String ex = file.getFileName().toString().substring(file.getFileName().toString().lastIndexOf(".") + 1);
        if (ex.equalsIgnoreCase("zip") || ex.equalsIgnoreCase("rar"))
        {
